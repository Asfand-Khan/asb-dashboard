...
const Page = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await axios.post("/api/service-page/content", formData);
  ...
  const fetchContent = async () => {
    try {
      const response = await axios.get("/api/service-page/content");
  ...
  return (
    <DefaultLayout>
      <Breadcrumb pageName="Service Content"/>
